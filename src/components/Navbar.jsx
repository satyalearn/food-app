...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between  w-[100%] bg-red-200 p-2'>
        <div className='flex items-center'>
        <div className='cursor-pointer' onClick={()=>{setNav(!nav)}}>
        <AiOutlineMenu  size={25}/>
        </div>
        <h1 className='text-xl sm:text-2xl lg:text-3xl px-2'>Best <span className='font-bold'>Eats</span></h1>
        ...
        <div className='px-2 w-[300px] sm:w-[400px] md:w-[500px] bg-gray-200 rounded-full flex items-center py-2'>
            ...
            <input type="text" placeholder='search food' className='bg-transparent focus:outline-none px-2 w-full' />
        </div>
        ...
        <div className={nav?'fixed top-0 left-0 w-[300px] h-screen z-10 bg-white duration-300': 'fixed top-0 left-[-100%] w-[300px] h-screen z-10 bg-white duration-300'}>
            <AiOutlineClose className='absolute right-4 top-4' onClick={()=>{setNav(!nav
                )}}/>
